    ...
    <div className="pt-24 pb-20 min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/40 dark:to-pink-900/40 rounded-full border border-purple-200 dark:border-purple-800 mb-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5">
          {filteredProjects.map((project) => (
            <div 
              key={project.id} 
              className={`group bg-white dark:bg-slate-800 rounded-2xl p-5 shadow-lg border-2 ${getDifficultyBorder(project.difficulty)} hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col`}
            >
      ...
      {/* Modal */}
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm" onClick={(e) => e.target === e.currentTarget && setSelectedProject(null)}>
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-3xl max-h-[85vh] overflow-hidden flex flex-col">
            <div className="flex justify-between items-center p-5 border-b border-slate-200 dark:border-slate-700">
              ...
              <button onClick={() => setSelectedProject(null)} className="p-2 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg">
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-4 border border-amber-200 dark:border-amber-800">
                ...
                <ul className="space-y-1">
                  {selectedProject.hints.map((hint, i) => (
                    <li key={i} className="flex items-start gap-2 text-amber-800 dark:text-amber-300 text-sm">
            ...
            <div className="flex gap-3 p-5 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50">
              <Link
                to="/playground"
                className="flex-1 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-semibold flex items-center justify-center gap-2"
