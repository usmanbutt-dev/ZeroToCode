      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
        ...
        <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/40 dark:to-purple-900/40 rounded-full border border-blue-200 dark:border-blue-800">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link 
                to="/playground" 
                className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl font-semibold text-lg shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition-all hover:-translate-y-1 text-center flex items-center justify-center gap-2"
              >
            ...
            <div className="flex items-center gap-6 pt-4">
              <div className="flex -space-x-3">
                {['bg-blue-500', 'bg-purple-500', 'bg-green-500', 'bg-orange-500'].map((color, i) => (
                  <div key={i} className={`w-10 h-10 rounded-full ${color} border-3 border-white dark:border-slate-900 flex items-center justify-center text-white font-bold text-sm shadow-lg`}>
          ...
          <div className="relative">
            ...
            <div className="relative bg-slate-900 rounded-2xl shadow-2xl border border-slate-700 overflow-hidden">
              {/* Terminal Header */}
              ...
              <div className="flex divide-x divide-slate-700">
                ...
                <div className="w-1/2 p-4 font-mono text-sm">
                  ...
                  <div className="bg-blue-500/20 border-l-2 border-blue-500 pl-2 -ml-2">ptr++;</div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="bg-green-500/10 border border-green-500/50 rounded p-2">
                      ...
                      <div className="flex gap-1">
                        ...
                        <div className="w-7 h-7 bg-purple-500/30 border border-purple-500 rounded flex items-center justify-center text-white text-xs font-bold animate-pulse">2</div>
      ...
      <section className="py-20 bg-white dark:bg-slate-900/50 border-y border-slate-200 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: <Layers className="w-6 h-6" />, title: "Stack Frames", desc: "Watch variables appear and disappear", color: "blue" },
              { icon: <Database className="w-6 h-6" />, title: "Heap Memory", desc: "See new/delete with leak detection", color: "orange" },
              { icon: <Eye className="w-6 h-6" />, title: "Pointer Tracking", desc: "Follow pointers to their targets", color: "purple" },
              { icon: <Box className="w-6 h-6" />, title: "Struct Fields", desc: "Visualize object member updates", color: "pink" },
            ].map((feature, idx) => (
              <div key={idx} className={`p-6 rounded-2xl bg-${feature.color}-50 dark:bg-${feature.color}-900/20 border border-${feature.color}-200 dark:border-${feature.color}-800 hover:shadow-lg transition-shadow group`}>
                <div className={`w-12 h-12 rounded-xl bg-gradient-to-br from-${feature.color}-500 to-${feature.color}-600 flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform`}>
                  {feature.icon}
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="relative">
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-lg border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-shadow h-full">
                  <div className="text-6xl font-bold text-slate-100 dark:text-slate-800 absolute top-4 right-6">{item.step}</div>
                  <div className="relative z-10">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white mb-6 shadow-lg shadow-blue-500/30">
                      {item.icon}
                    </div>
