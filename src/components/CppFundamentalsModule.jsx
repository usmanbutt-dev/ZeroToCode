...
const CppFundamentalsModule = () => {
  const topics = [
    {
      title: "Introduction to C++",
      description: "High-performance language for games and systems.",
      icon: (
    ...
    },
    {
      ...
      description: "int, float, double, char, bool.",
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "Operators",
      description: "Arithmetic, comparison, logical.",
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex-1 space-y-6">
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Start writing real code. Learn the core building blocks of the C++ language through simple examples.
            </p>
          </div>
          ...
          <button className="w-full sm:w-auto px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-semibold transition-all shadow-lg shadow-orange-500/30 hover:-translate-y-0.5">
            Start Module
          </button>
        </div>
        ...
        <div className="lg:w-80 flex-shrink-0">
          <div className="h-full min-h-[300px] bg-slate-100 dark:bg-slate-900 rounded-xl border-2 border-dashed border-slate-200 dark:border-slate-700 p-6 flex flex-col items-center justify-center text-center relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-4">
              <div className="w-20 h-20 mx-auto bg-white dark:bg-slate-800 rounded-full shadow-lg flex items-center justify-center text-orange-500 mb-4">
                <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                </svg>
              </div>
              <div>
                <h4 className="font-bold text-slate-900 dark:text-white mb-1">Live Code Preview</h4>
                <p className="text-sm text-slate-500 dark:text-slate-400">
                  See real-time output of your C++ code examples.
                </p>
              </div>
              <div className="pt-4">
...
export default CppFundamentalsModule;
